...
<table width="400" border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td><form id="form1" name="form1" method="post" action="add_member2.php" onsubmit="return chk_form()">
      <fieldset>
        ...
        <table width="400" border="0" cellspacing="2" cellpadding="0">
		  ...
		  <tr>
            ...
            <td><input name="mb_identity" type="text" id="mb_identity" size="30" /></td>
          </tr>
          <tr>
		...
		<select  name="mb_title_name" id="mb_title_name">
          ...
          <tr>
            ...
            <td><input name="mb_teacher" type="text" id="mb_teacher" size="30" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
