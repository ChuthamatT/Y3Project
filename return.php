      ...
      <table width="940" border="0" cellspacing="2" cellpadding="0">
        ...
        <tr>
          <td><table width="920" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td width="47">&nbsp;</td>
              <td width="697">รายการยืม - คืนอุปกรณ์</td>
              <td width="168">&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td><form id="form1" name="form1" method="post" action="return.php" onsubmit="return chk_form()">
                  <fieldset>
                    <legend>ค้นหาวันที่ทำรายการ</legend>
            ...
            <table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
              ...
              <tr>
                <td><div align="center"><font size="+1">รายการยืม - คืนอุปกรณ์</font></div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
            ...
            <table width="900" border="1" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                <?php if ($rs["status"]==1) { ?>
                <a href="rtn_status.php?bid=<?php echo $rs["id"]; ?>"><img src="images/icon/1352332780_001_06.gif" width="24" height="24" border="0" /></a>
                <?php } else { ?>
                &nbsp;
                <?php } ?>
                </td>
