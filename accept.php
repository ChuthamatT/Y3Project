...
function del_buy(val1) {
	if (confirm("คุณแน่ใจหรือว่าต้องการลบข้อมูลนี้ ?")==true) {
...
function find_buy() {
	if (document.getElementById("stdate").value=="" || document.getElementById("endate").value=="") {
		...
		top.window.location='accept.php?stdate='+document.getElementById("stdate").value+'&endate='+document.getElementById("endate").value;	
	}
}
</script>
</head>
        ...
        <tr>
          <td><table width="920" border="0" align="center" cellpadding="0" cellspacing="2">
            ...
            <table width="900" border="1" align="center" cellpadding="0" cellspacing="0">
              <tr class="h_table">
                <td width="74" height="25">ลำดับ</td>
                <td width="143">ปส.ที่</td>
                <td width="137">วันที่</td>
                <td width="237">ใบขอจัดซื้อ</td>
                <td width="175">สถานะ</td>
                <td width="120">จัดการ</td>
                </tr>
              <?php
              ...
              <tr>
                ...
                <td><div align="center">
                <a href="ch_status.php?bid=<?php echo $rs["id"]; ?>&st=2"><img src="images/icon/1352332780_001_06.gif" width="24" height="24" border="0" /></a>
                &nbsp;
                <a href="ch_status.php?bid=<?php echo $rs["id"]; ?>&st=4"><img src="images/icon/1352332857_001_05.gif" width="24" height="24" border="0" /></a>
                </div></td>
                </tr>
              <?php } ?>
            </table>
