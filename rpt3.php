...
<title>รายงานยืม - คืน อุปกรณ์กีฬา</title>
        ...
        <tr>
          <td><table width="920" border="0" align="center" cellpadding="0" cellspacing="2">
            ...
            <table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td><form id="form1" name="form1" method="post" action="rpt3_3.php?stt_p=<?=$_GET['stt_p']?>" target="_blank" onsubmit="return chk_form()">
                  <fieldset>
