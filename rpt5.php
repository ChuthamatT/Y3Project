      ...
      <table width="940" border="0" cellspacing="2" cellpadding="0">
        ...
        <tr>
          <td><table width="920" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td width="47">&nbsp;</td>
              <td width="697"><div align="left"><font size="+1">
            ...
            <table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td><form id="form1" name="form1" method="post" action="rpt5_5.php" target="_blank" onsubmit="return chk_form()">
                  <fieldset>
                    <legend>เงื่อนไขในการทำรายงาน</legend>
                    <table width="350" border="0" align="center" cellpadding="0" cellspacing="2">
              <tr>
                <td width="85" height="30"><strong>ประจำเดือน</strong></td>
                <td width="259">
              ...
              <tr>
                <td colspan="2"><div align="center"><input type="submit" name="button" id="button" value="ออกรายงาน" /></div></td>
                </tr>
            </table>
                  </fieldset>
                </form></td>
