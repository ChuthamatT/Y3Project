...
<title>ระบบยืม - คืน อุปกรณ์มหาวิทยาลัยธนบุรี</title>
    ...
    <div id="container">
      <table width="940" border="0" cellspacing="2" cellpadding="0">
        ...
        <tr>
          ...
          <form id="form1" name="form1" method="post" action="add_buy2.php" onsubmit="return chk_form()">
            <table width="700" border="0" align="center" cellpadding="0" cellspacing="2">
                  ...
                  <fieldset>
                    ...
                    <table width="700" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        ...
                        <td width="553"><input name="subject" type="text" id="subject" size="50" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><textarea name="want" id="want" cols="45" rows="5"></textarea></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><div align="right"><a href="add_item.php" id="add1" class="various iframe"><img src="images/icon/1352332838_001_01.png" width="24" height="24" border="0" /></a></div></td>
                        <td><a href="add_item.php" id="add2" class="various iframe">เพิ่มรายการ</a></td>
                      </tr>
                    </table>
                  </fieldset>
                </td>
              ...
              <tr>
                <td><div align="center"><iframe name="frame1" id="frame1" src="item.php" width="700" height="200" frameborder="0"></iframe></div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td><div align="center"><input type="submit" name="button" id="button" value="เพิ่มใบสั่งซื้อ" /></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </form>
