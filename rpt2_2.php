...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    <td><table width="900" border="0" cellspacing="2" cellpadding="0">
      ...
      <tr>
        <td class="h_1">รายงานการตรวจรับพัสดุ</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
    ...
    <?php if (mysqli_num_rows($result) > 0) {  ?>
      <table width="900" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr class="h_table">
          <td width="54" height="25">ลำดับ</td>
          <td width="153">ปส.ที่</td>
          <td width="155">วันที่ตรวจรับ</td>
          <td width="198">เอกสารที่แนบมาด้วย</td>
          <td width="177">ฝ่าย</td>
        </tr>
        <?php
