...
$sql=" select * from user_info where id=$_GET[id_edit] ";
...
<table width="400" border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td><form id="form1" name="form1" method="post" action="edit_user2.php" onsubmit="return chk_form()">
      <fieldset>
        ...
        <table width="400" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            ...
            <td><input name="fname" type="text" id="fname" size="30" value="<?php echo $rs["fname"]; ?>" /></td>
          </tr>
          <tr>
            <td><div align="right">นามสกุล : </div></td>
            <td><input name="lname" type="text" id="lname" size="30" value="<?php echo $rs["lname"]; ?>" /></td>
          </tr>
          <tr>
            <td><div align="right">ตำแหน่ง : </div></td>
            <td><input name="position" type="text" id="position" size="30" value="<?php echo $rs["position"]; ?>" /></td>
          </tr>
          <tr>
            <td><div align="right">Username : </div></td>
            <td><input type="text" name="username" id="username" value="<?php echo $rs["username"]; ?>" /></td>
          </tr>
          <tr>
